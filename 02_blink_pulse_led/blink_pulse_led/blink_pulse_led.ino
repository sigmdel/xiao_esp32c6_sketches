/*
 * blink_pulse_led.ino
 * Alternately blinks (heartbeat) and pulses the on-board LED
 * of the XIAO ESP32C6 dev board
 * 
 ...
 * June 25, 2025
 *
 * Copyright 2025, Michel Deslierres. No rights reserved, this code is in the public domain.
