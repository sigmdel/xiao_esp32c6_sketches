...
Set the Button Switch GPIO by changing the `GPIO_INPUT_IO_TOGGLE_SWITCH` definition. By default, the TOGGLE_SWITCH pin is `GPIO_NUM_9` which is the Boot button on many ESP32-C6 boards.
